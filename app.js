...
//const mongodb_URI = "mongodb+srv://bbeizer:GHrxlQGMkxJYMeYg@cluster0.wvrxu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
async (req,res,next) => {
  try{
    ...
    let data = {userId, title, album, artist, genre} // create the data object
    let item = new Song(data) // create the database object (and test the types are correct)
